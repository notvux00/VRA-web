...
This project is indexed by GitNexus as **VRA-web** (1396 symbols, 2481 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/VRA-web/context` | Codebase overview, check index freshness |
| `gitnexus://repo/VRA-web/clusters` | All functional areas |
| `gitnexus://repo/VRA-web/processes` | All execution flows |
| `gitnexus://repo/VRA-web/process/{name}` | Step-by-step execution trace |
